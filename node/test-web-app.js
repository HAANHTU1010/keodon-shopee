...
async function chay() {
  ...
  console.log('\n--- YC-42: ma trận máy × Google trên đường xuLy (cửa theo khoảng tương thích) ---');
  {
    ...
    // Mốc theo bản HIỆN HÀNH (đọc từ module), không gõ cứng số bản — gõ cứng thì mỗi lần nâng bản bài này vỡ vì mốc, không vì mã.
    const MOC_BAN_MAY = "const PHIEN_BAN = '" + PHIEN_BAN + "';";
    ...
    const MOC_BAN_GS = "var PHIEN_BAN = '" + PHIEN_BAN + "';";
