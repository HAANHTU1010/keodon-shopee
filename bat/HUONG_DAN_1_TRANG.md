...
> **Gói này chỉ chạy trên máy Windows.** Bốn nút là file `.bat`, và bản Node kèm theo là bản Windows. Máy Mac vẫn **mở và xem sổ Google bình thường**, chỉ không bấm được bốn nút này — việc kéo đơn để một máy Windows làm. Bản bấm nút ngay trong Google Sheet, chạy được mọi máy, đang nằm trong kế hoạch sau đợt TikTok.
